...
<head>
    ...
    <title>Client Đăng ký | Shop Nam</title>
    <style>
        :root { color-scheme: dark; font-family: 'Inter', system-ui, sans-serif; }
        * { box-sizing: border-box; }
        body { margin: 0; min-height: 100vh; background: radial-gradient(circle at top right, rgba(234, 179, 8, .12), transparent 18%), #07111f; color: #f8fafc; }
...
<body>
    <div class="page-shell">
        <div class="auth-card">
            <div class="hero">
                <h1>Đăng ký Client</h1>
                <p>Tham gia mua sắm thời trang nam, cập nhật phong cách và theo dõi đơn hàng nhanh chóng.</p>
            </div>
            <div class="form-card">
                @if ($errors->any())
                    <div class="error">
