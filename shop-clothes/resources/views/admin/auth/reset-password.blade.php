...
<head>
    ...
    <title>Đặt lại mật khẩu Admin | Shop Nam</title>
    <style>
        :root { color-scheme: dark; font-family: 'Inter', system-ui, sans-serif; }
        * { box-sizing: border-box; }
        body { margin: 0; min-height: 100vh; background: radial-gradient(circle at bottom left, rgba(245, 158, 11, .12), transparent 18%), #07111f; color: #f8fafc; }
        ...
        input:focus { border-color: #22d3ee; box-shadow: 0 0 0 4px rgba(34, 211, 238, .12); outline: none; }
        button { width: 100%; margin-top: 22px; padding: 15px 18px; border: none; border-radius: 16px; background: linear-gradient(135deg, #f59e0b, #ea580c); color: #111827; font-weight: 700; cursor: pointer; }
    ...
    <div class="page-shell">
        <div class="auth-card">
            <div class="hero">
                ...
                <p>Nhập email, mật khẩu mới và xác nhận để cập nhật tài khoản quản trị.</p>
            </div>
            <div class="form-card">
                @if ($errors->any())
                    <div class="error">
